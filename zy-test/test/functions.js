...
addAccount(eth.accounts[2], "Account #2 - User #1");
addAccount(eth.accounts[3], "Account #3 - User #2");
addAccount(eth.accounts[4], "Account #4 - Executor #1");
addAccount(eth.accounts[5], "Account #5 - Executor #2");
addAccount(eth.accounts[6], "Account #6 - Business #1");
...
var executor1 = eth.accounts[4];
var excutor2 = eth.accounts[5];
var business1 = eth.accounts[6];
